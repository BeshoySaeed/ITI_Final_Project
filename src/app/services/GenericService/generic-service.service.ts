...
export class GenericService {
  ...
  updateCart(route: string, object: any): Observable<any> {
    return this.http
      .put(`${environment.host}/${route}`, object)
      .pipe(retry(2), catchError(this.handleError));
  }
